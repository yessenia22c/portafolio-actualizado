  ...
  return (
    <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
      <section className="lg:grid flex flex-col grid-cols-[auto]  grid-flow-col gap-4">
        <article className="bg-gradient-to-b from-[#004c784d] to-[#00132e] border border-[#00ba95] p-4 rounded-xl">
        ...
        <article className="bg-gradient-to-b lg:col-span-2 from-[#004c784d] to-[#00132e] border border-[#00ba95] p-8 rounded-xl">
          <div>
