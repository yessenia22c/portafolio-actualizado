...
export const Tecnologias = () => {
  return (
    <ul className="flex flex-wrap gap-2">
      ...
      <li className=" flex flex-col justify-center items-center gap-1 text-[13px] text-gray-900 dark:text-white px-2 py-2 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 252" width={30} height={30}>
